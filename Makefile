...
OBJECTS=cmparser.o cmlexer.o symbolTable.o ast.o util.o typecheck.o codegen.o

SOURCES=cmlexer.l cmparser.y symbolTable.c ast.c util.c typecheck.c codegen.c
